<template>
  <div class="member-csv-upload">
    <h3>Upload Members from CSV</h3>
    
    <div class="format-info">
      <h4>CSV Format Requirements:</h4>
      <div class="format-example">
        <pre>name,gender,is_committee
John Doe,M,true
Jane Smith,F,false
Alice Johnson,F,true</pre>
      </div>
      <ul class="format-rules">
        <li><strong>name</strong>: Member's full name</li>
        <li><strong>gender</strong>: 'M' for Male, 'F' for Female</li>
        <li><strong>is_committee</strong>: true/false, yes/no, 1/0</li>
      </ul>
    </div>
        ...
        <div v-if="uploadResult.success && uploadResult.data" class="result-summary">
          <div class="summary-stats">
            <div class="stat-item">
              ...
              <span class="stat-value">{{ uploadResult.data.created_count }}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">Updated:</span>
              <span class="stat-value">{{ uploadResult.data.updated_count }}</span>
            </div>
            <div class="stat-item">
...
const uploadCSV = async () => {
  ...
  try {
    ...
    const response = await fetch('/members/upload-csv', {
      method: 'POST',
      body: formData
    })
